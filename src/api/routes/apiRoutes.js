...
router.get('/tracking/bus/:plateNumber', (req, res) => telemetryController.getBusByNumber(req, res));
router.get('/tracking/bus', (req, res) => telemetryController.getBusByNumber(req, res));
router.get('/vehicles/:plateNumber', (req, res) => telemetryController.getBusByNumber(req, res));
