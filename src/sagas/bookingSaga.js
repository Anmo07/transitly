...
class BookingSaga {
  ...
  async execute(bookingRequest) {
    ...
    try {
      ...
      const opId = bookingRequest.operatorId || 1;
      ...
      shipment = await Shipment.create({
        ...
        version: 1,
        capacitySlotId: bookingRequest.capacitySlotId || undefined,
        assignedVehicleId: bookingRequest.vehicleId || undefined,
        assignedRouteId: bookingRequest.routeId || undefined,
        qrSeal: {
      ...
      if (bookingRequest.capacitySlotId) {
        try {
